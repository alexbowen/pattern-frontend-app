      ...
      <ul className="list-group list-group-horizontal d-flex align-items-baseline">
        <li className="list-group-item">
          <a href="https://www.facebook.com/groups/patternradio" target="_blank">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-{{ social.channel }}" viewBox="0 0 16 16">
        ...
        <li className="list-group-item">
          <a href="https://www.instagram.com/patternradio_pt/" target="_blank">
